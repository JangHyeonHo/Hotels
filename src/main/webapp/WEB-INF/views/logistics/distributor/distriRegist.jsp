...
<!-- 헤더 푸터 건들지 말것(필수는 아님) -->
	...
	<h2>유통업체 등록</h2>
		...
		<span class = "spn"><spring:message code="dist.regist" /> : </span><input type = "file" class = "btn btn-outline-secondary" name = "csvFile"><br>
		<input type = "submit" class = "btn-b btn btn-outline-danger" value = "<spring:message code="regist" />">
		<input type = "button" id = "submitBtn3" onclick="history.back(-1)" value = "뒤로가기" class = "btn-b btn btn-primary btn">
		</form:form>
	</div>
	</div>
